...
(function(e, t, n, r) {
    ...
    n.extend(u, {
        ...
        showLoading: function() {
            ...
            o.on("keydown.loading", function(e) {
        ...
        bindEvents: function() {
            ...
            s.on("orientationchange.fb" + (l ? "" : " resize.fb") + (e.autoCenter && !e.locked ? " scroll.fb" : ""), u.update);
            t = e.keys;
            if (t) {
                o.on("keydown.fb", function(i) {
            ...
            if (n.fn.mousewheel && e.mouseWheel) {
                u.wrap.on("mousewheel.fb", function(t, r, i, s) {
                    var o = t.target || null,
                        a = n(o),
                        f = false;
                    while (a.length) {
        ...
        _afterZoomIn: function() {
            ...
            if (e.closeClick || e.nextClick && u.group.length > 1) {
                u.inner.css("cursor", "pointer").on("click.fb", function(t) {
            ...
            if (e.closeBtn) {
                n(e.tpl.closeBtn).appendTo(u.skin).on("click.fb", function(e) {
                    e.preventDefault();
                    u.close()
                })
            }
            if (e.arrows && u.group.length > 1) {
                if (e.loop || e.index > 0) {
                    n(e.tpl.prev).appendTo(u.outer).on("click.fb", u.prev)
                }
                if (e.loop || e.index < u.group.length - 1) {
                    n(e.tpl.next).appendTo(u.outer).on("click.fb", u.next)
                }
            }
            u.trigger("afterShow");
    ...
    u.helpers.overlay = {
        ...
        open: function(e) {
            ...
            if (!this.fixed) {
                s.on("resize.overlay", n.proxy(this.update, this));
                this.update()
            }
            if (e.closeClick) {
    ...
    n.fn.esgbox = function(e) {
        ...
        t = e.index || 0;
        if (!i || e.live === false) {
            r.unbind("click.fb-start").on("click.fb-start", s)
        } else {

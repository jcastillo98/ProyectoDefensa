...
function themerex_ready_actions() {
    ...
    jQuery('.menu_main_wrap .menu_main_nav > li > ul > li.close').on('click', function() {
		"use strict";
    ...
    //subsub menu
    jQuery('.menu_main_wrap .menu_main_nav > li > ul > li.menu-item-has-children > a').on('click', function(e) {
		"use strict";
    ...
    jQuery('.menu_main_wrap .menu_main_nav > li > ul > li > ul > li.back').on('click', function() {
		"use strict";
        jQuery('.menu_main_wrap .menu_main_nav > li > ul > li.open').removeClass('open');
    });
    ...
    jQuery('.menu_user_login .popup_link').on('click', function() {
		"use strict";
    ...
    jQuery('.menu_user_register .popup_link ').on('click', function() {
		"use strict";
        jQuery(this).addClass('open');
    ...
    jQuery('#popup_registration .popup_close, #popup_login .popup_close').on('click', function() {
		"use strict";
        jQuery('.menu_user_login .popup_link, .menu_user_register .popup_link').removeClass('open');
    });

    jQuery('.menu_user_wrap .menu_user_right .menu_button').unbind("click").on('click', function(e) {
		"use strict";
        ShowMenu(this);
...
function themerex_resize_actions() {
    ...
    if (jQuery(window).width() > 480) {
        jQuery('.menu_main_wrap .menu_main_nav > li > a').on( "mouseenter mouseleave", function(e) {
            OpenMenu(this);
        ...
        jQuery('.menu_main_wrap .menu_main_nav > li.menu-item-has-children > a').on('click', function(e) {
            OpenMenu(this);
